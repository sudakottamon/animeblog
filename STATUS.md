...
デザイン方針: SWELL/JIN系の国産アフィブログ様式（白ベース・グレー帯h2・オレンジCTA＋赤マイクロコピー・フラット枠線・システムフォント・ライト固定）。紫グラデ／ガラス風／ピル形状／Interは「AI生成の典型」なので禁止。
リライト進捗（WRITING.md準拠）: 全16本＋/vod/ 完了（2026-08-28）。以降の新規記事は最初からWRITING.md文体で書く。
次フェーズ: 新規記事量産（今期作品の個別記事、ジャンル別ランキング拡充）＋運営ルーチン（レゼ篇9/19解禁更新、薬屋3期10/2、鬼滅解禁監視、affiliates.json料金照合）。
